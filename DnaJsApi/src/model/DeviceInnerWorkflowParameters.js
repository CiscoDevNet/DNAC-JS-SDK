...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Swagger.DeviceInnerWorkflowParameters = factory(root.Swagger.ApiClient, root.Swagger.ResetRequestConfigList);
  }
  ...
  /**
   * The DeviceInnerWorkflowParameters model module.
   * @module model/DeviceInnerWorkflowParameters
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DeviceInnerWorkflowParameters</code>.
   * @alias module:model/DeviceInnerWorkflowParameters
   * @class
   */
  ...
  /**
   * Constructs a <code>DeviceInnerWorkflowParameters</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeviceInnerWorkflowParameters} obj Optional instance to populate.
   * @return {module:model/DeviceInnerWorkflowParameters} The populated <code>DeviceInnerWorkflowParameters</code> instance.
   */
