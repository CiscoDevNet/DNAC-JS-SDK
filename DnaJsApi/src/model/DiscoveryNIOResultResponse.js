...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Swagger.DiscoveryNIOResultResponse = factory(root.Swagger.ApiClient, root.Swagger.HTTPReadCredentialDTOInner);
  }
  ...
  /**
   * The DiscoveryNIOResultResponse model module.
   * @module model/DiscoveryNIOResultResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DiscoveryNIOResultResponse</code>.
   * @alias module:model/DiscoveryNIOResultResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DiscoveryNIOResultResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DiscoveryNIOResultResponse} obj Optional instance to populate.
   * @return {module:model/DiscoveryNIOResultResponse} The populated <code>DiscoveryNIOResultResponse</code> instance.
   */
