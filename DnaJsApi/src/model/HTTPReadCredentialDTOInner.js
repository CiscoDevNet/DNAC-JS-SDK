...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Swagger.HTTPReadCredentialDTOInner = factory(root.Swagger.ApiClient);
  }
  ...
  /**
   * The HTTPReadCredentialDTOInner model module.
   * @module model/HTTPReadCredentialDTOInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>HTTPReadCredentialDTOInner</code>.
   * @alias module:model/HTTPReadCredentialDTOInner
   * @class
   */
  ...
  /**
   * Constructs a <code>HTTPReadCredentialDTOInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HTTPReadCredentialDTOInner} obj Optional instance to populate.
   * @return {module:model/HTTPReadCredentialDTOInner} The populated <code>HTTPReadCredentialDTOInner</code> instance.
   */
  ...
  /**
   * @member {module:model/HTTPReadCredentialDTOInner.CredentialTypeEnum} credentialType
   */
