...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Swagger.CreateSSIDResponse = factory(root.Swagger.ApiClient);
  }
  ...
  /**
   * The CreateSSIDResponse model module.
   * @module model/CreateSSIDResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CreateSSIDResponse</code>.
   * @alias module:model/CreateSSIDResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CreateSSIDResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateSSIDResponse} obj Optional instance to populate.
   * @return {module:model/CreateSSIDResponse} The populated <code>CreateSSIDResponse</code> instance.
   */
