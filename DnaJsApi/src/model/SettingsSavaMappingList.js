...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Swagger.SettingsSavaMappingList = factory(root.Swagger.ApiClient, root.Swagger.SAVAMappingProfile, root.Swagger.SAVAMappingSyncResult);
  }
  ...
  /**
   * The SettingsSavaMappingList model module.
   * @module model/SettingsSavaMappingList
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SettingsSavaMappingList</code>.
   * @alias module:model/SettingsSavaMappingList
   * @class
   */
  ...
  /**
   * Constructs a <code>SettingsSavaMappingList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SettingsSavaMappingList} obj Optional instance to populate.
   * @return {module:model/SettingsSavaMappingList} The populated <code>SettingsSavaMappingList</code> instance.
   */
  ...
  /**
   * @member {module:model/SettingsSavaMappingList.SyncStatusEnum} syncStatus
   */
