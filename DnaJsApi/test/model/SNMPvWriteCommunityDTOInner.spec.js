...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.SNMPvWriteCommunityDTOInner();
  });
  ...
  describe('SNMPvWriteCommunityDTOInner', function() {
    it('should create an instance of SNMPvWriteCommunityDTOInner', function() {
      // uncomment below and update the code to test SNMPvWriteCommunityDTOInner
      //var instane = new Swagger.SNMPvWriteCommunityDTOInner();
      //expect(instance).to.be.a(Swagger.SNMPvWriteCommunityDTOInner);
    });
    ...
    it('should have the property writeCommunity (base name: "writeCommunity")', function() {
      // uncomment below and update the code to test the property writeCommunity
      //var instane = new Swagger.SNMPvWriteCommunityDTOInner();
      //expect(instance).to.be();
    });
