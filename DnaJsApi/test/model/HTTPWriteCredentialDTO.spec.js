...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.HTTPWriteCredentialDTO();
  });
  ...
  describe('HTTPWriteCredentialDTO', function() {
    it('should create an instance of HTTPWriteCredentialDTO', function() {
      // uncomment below and update the code to test HTTPWriteCredentialDTO
      //var instane = new Swagger.HTTPWriteCredentialDTO();
      //expect(instance).to.be.a(Swagger.HTTPWriteCredentialDTO);
    });
