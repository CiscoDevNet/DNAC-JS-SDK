...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.SettingsSavaMappingList();
  });
  ...
  describe('SettingsSavaMappingList', function() {
    it('should create an instance of SettingsSavaMappingList', function() {
      // uncomment below and update the code to test SettingsSavaMappingList
      //var instane = new Swagger.SettingsSavaMappingList();
      //expect(instance).to.be.a(Swagger.SettingsSavaMappingList);
    });
