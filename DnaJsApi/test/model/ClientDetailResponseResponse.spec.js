...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.ClientDetailResponseResponse();
  });
  ...
  describe('ClientDetailResponseResponse', function() {
    it('should create an instance of ClientDetailResponseResponse', function() {
      // uncomment below and update the code to test ClientDetailResponseResponse
      //var instane = new Swagger.ClientDetailResponseResponse();
      //expect(instance).to.be.a(Swagger.ClientDetailResponseResponse);
    });
