...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.CLICredentialDTOInner();
  });
  ...
  describe('CLICredentialDTOInner', function() {
    it('should create an instance of CLICredentialDTOInner', function() {
      // uncomment below and update the code to test CLICredentialDTOInner
      //var instane = new Swagger.CLICredentialDTOInner();
      //expect(instance).to.be.a(Swagger.CLICredentialDTOInner);
    });
