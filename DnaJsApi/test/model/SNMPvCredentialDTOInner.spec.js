...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.SNMPvCredentialDTOInner();
  });
  ...
  describe('SNMPvCredentialDTOInner', function() {
    it('should create an instance of SNMPvCredentialDTOInner', function() {
      // uncomment below and update the code to test SNMPvCredentialDTOInner
      //var instane = new Swagger.SNMPvCredentialDTOInner();
      //expect(instance).to.be.a(Swagger.SNMPvCredentialDTOInner);
    });
    ...
    it('should have the property privacyPassword (base name: "privacyPassword")', function() {
      // uncomment below and update the code to test the property privacyPassword
      //var instane = new Swagger.SNMPvCredentialDTOInner();
      //expect(instance).to.be();
    });

    it('should have the property privacyType (base name: "privacyType")', function() {
