...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.DeleteSSIDResponse();
  });
  ...
  describe('DeleteSSIDResponse', function() {
    it('should create an instance of DeleteSSIDResponse', function() {
      // uncomment below and update the code to test DeleteSSIDResponse
      //var instane = new Swagger.DeleteSSIDResponse();
      //expect(instance).to.be.a(Swagger.DeleteSSIDResponse);
    });
