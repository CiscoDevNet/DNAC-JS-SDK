...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.CreateSSIDResponse();
  });
  ...
  describe('CreateSSIDResponse', function() {
    it('should create an instance of CreateSSIDResponse', function() {
      // uncomment below and update the code to test CreateSSIDResponse
      //var instane = new Swagger.CreateSSIDResponse();
      //expect(instance).to.be.a(Swagger.CreateSSIDResponse);
    });
