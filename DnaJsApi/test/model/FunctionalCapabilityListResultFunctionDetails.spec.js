...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.FunctionalCapabilityListResultFunctionDetails();
  });
  ...
  describe('FunctionalCapabilityListResultFunctionDetails', function() {
    it('should create an instance of FunctionalCapabilityListResultFunctionDetails', function() {
      // uncomment below and update the code to test FunctionalCapabilityListResultFunctionDetails
      //var instane = new Swagger.FunctionalCapabilityListResultFunctionDetails();
      //expect(instance).to.be.a(Swagger.FunctionalCapabilityListResultFunctionDetails);
    });
