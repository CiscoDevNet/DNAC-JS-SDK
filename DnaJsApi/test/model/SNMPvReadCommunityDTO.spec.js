...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.SNMPvReadCommunityDTO();
  });
  ...
  describe('SNMPvReadCommunityDTO', function() {
    it('should create an instance of SNMPvReadCommunityDTO', function() {
      // uncomment below and update the code to test SNMPvReadCommunityDTO
      //var instane = new Swagger.SNMPvReadCommunityDTO();
      //expect(instance).to.be.a(Swagger.SNMPvReadCommunityDTO);
    });
    ...
    it('should have the property readCommunity (base name: "readCommunity")', function() {
      // uncomment below and update the code to test the property readCommunity
      //var instane = new Swagger.SNMPvReadCommunityDTO();
      //expect(instance).to.be();
    });
