...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.HTTPReadCredentialDTOInner();
  });
  ...
  describe('HTTPReadCredentialDTOInner', function() {
    it('should create an instance of HTTPReadCredentialDTOInner', function() {
      // uncomment below and update the code to test HTTPReadCredentialDTOInner
      //var instane = new Swagger.HTTPReadCredentialDTOInner();
      //expect(instance).to.be.a(Swagger.HTTPReadCredentialDTOInner);
    });
