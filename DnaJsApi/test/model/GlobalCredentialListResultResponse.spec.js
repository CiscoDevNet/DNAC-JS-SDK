...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.GlobalCredentialListResultResponse();
  });
  ...
  describe('GlobalCredentialListResultResponse', function() {
    it('should create an instance of GlobalCredentialListResultResponse', function() {
      // uncomment below and update the code to test GlobalCredentialListResultResponse
      //var instane = new Swagger.GlobalCredentialListResultResponse();
      //expect(instance).to.be.a(Swagger.GlobalCredentialListResultResponse);
    });
