...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.ProjectDTO();
  });
  ...
  describe('ProjectDTO', function() {
    it('should create an instance of ProjectDTO', function() {
      // uncomment below and update the code to test ProjectDTO
      //var instane = new Swagger.ProjectDTO();
      //expect(instance).to.be.a(Swagger.ProjectDTO);
    });
