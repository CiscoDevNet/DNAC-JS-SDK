...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Swagger.RegisterNetworkDeviceResultResponse();
  });
  ...
  describe('RegisterNetworkDeviceResultResponse', function() {
    it('should create an instance of RegisterNetworkDeviceResultResponse', function() {
      // uncomment below and update the code to test RegisterNetworkDeviceResultResponse
      //var instane = new Swagger.RegisterNetworkDeviceResultResponse();
      //expect(instance).to.be.a(Swagger.RegisterNetworkDeviceResultResponse);
    });
